...
public class ArrayListConcept {
	...
	public static void main(String[] args) {
		...
		for(String s : studentNames){
			System.out.println(count + " " + s);// we can use count to give number or index
				if(s.equals("Sri")){
		...
		// It's for each loop or Enhance for loop
		// we can only use when we have to print all the value
